...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200924204432_AddedApplicationUser')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200924204432_AddedApplicationUser')
BEGIN
    ALTER TABLE [AspNetUsers] ADD [BirthDate] nvarchar(max) NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200924204432_AddedApplicationUser', N'3.1.8');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200925044035_addedTeams')
BEGIN
    CREATE TABLE [Teams] (
        [Id] int NOT NULL IDENTITY,
        [TeamName] nvarchar(max) NOT NULL,
        [Email] nvarchar(max) NOT NULL,
        [EstablishedDate] nvarchar(max) NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200925044035_addedTeams', N'3.1.8');
END;
